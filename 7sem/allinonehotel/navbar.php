            ...
            <ul class="navbar-nav">
              ...
              if(isset($_COOKIE['logged'])){
                if($_COOKIE['logged']!='reset' ){
                  ...
                  <ul class="dropdown-menu p-1"  style = "margin-left:-80px;height:40vh;overflow-x:scroll; " aria-labelledby="navbarDropdownMenuLink" >
                   ';
                    ...
                    if(count($result)>0){
                      foreach($result as $row){
                        if($_COOKIE["logged"]=='admin@email.com') {
                          ...
                          echo "<a href=' admin' style='background-color:grey;'><button class = 'btn btn-primary mb-2 p-1'> Room number assigned : <span class='badge badge-info'>".$row["room_number"]."</span></button></a>";
                          }
                          else{
                            
                          echo "<a href='admin' ><button class = 'btn btn-primary mb-2 p-1'> Room number assigned : <span class='badge badge-info'>".$row["room_number"]."</span></button></a>";
                          }
                        }
                        else
                        {
