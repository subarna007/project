        ...
        <div class="blocks">
            <div class="card" style="width:23rem;">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item"><i class="bi bi-bicycle"> </i>Cycling </li>
                </ul>
                <div class="card-body ">
            ...
            <div class="card " style="width: 23rem;">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item"><i class="bi bi-egg-fried"> </i>Lunch & Breakfast<span class="badge rounded-pill bg-primary text-light">Free</span></li>
                  <li class="list-group-item"><i class="bi bi-bicycle"> </i>Cycling <span class="badge rounded-pill bg-primary text-light">Free</span></li>
                </ul>
                <div class="card-body">
                <a onclick="bought(this,'gold')" class="btn btn-dark">Buy Now for <span class="badge rounded-pill bg-warning ">NRs-4500</span></a>
                </div>
            </div>
        </div>
    </div>
...
if(isset($_POST["data11"])&&isset($_COOKIE["logged"])){
