...
if(count($result2)>0){
    echo "<caption><h2>Adventure records</h2></caption><table>";
...
echo "</table>";
    ...
    echo "<h3>No adventure booked yet</h3";
}
...
$result2=$conn->own_query($sql2);
if(count($result2)>0)
{echo "<br><caption><h2>Food records</h2></caption><table>";
